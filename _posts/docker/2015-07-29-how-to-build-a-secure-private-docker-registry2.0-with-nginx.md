---
layout: article
title:  "如何利用nginx及Registry2.0搭建Docker安全私有仓库"
categories: docker
disqus: true
image:
...
在Docker还并未发布1.0版本时，我们就开始关注并进行相关技术的预研工作。2014年年中，为了配合新产品的发版，我们在基础运行环境中预装了Java、Git、Zsh等多个工具。利用shell从git上拉取各个组件进行打包编译，通过fabric自动化脚本将该产品部署在Docker容器中，用于产品单机和集群环境的功能、性能测试。在这个过程中，我们解决了字符集、时间不同步等诸多问题，最终该产品的基础镜像已累积到上GB的大小。
